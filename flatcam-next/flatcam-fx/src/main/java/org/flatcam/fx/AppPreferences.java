 ...
 * selected theme, window size, and split-pane divider positions. Not a
 * general settings/preferences system - the real one (per-object options,
 * import/export, factory defaults - see UI_INVENTORY.md section 4) is much
 * bigger scope and belongs to a later phase; this is only what Fase 1's
 * shell itself needs to remember about its own layout.
 */
